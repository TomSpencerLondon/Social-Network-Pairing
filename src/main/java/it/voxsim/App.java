...
public class App {
	...
	// §TODO 1. We should extract this to the CommandDispatcher (factory)
	// This creates the factory for the commands
	// Creates the dependencies for the factory and should be in the factory
